...
enum McLibrary implements LibraryType {
	...
	MC_SERVER(EnvType.SERVER, "org/bukkit/craftbukkit/Main.class", "net/minecraft/server/Main.class", "net/minecraft/server/MinecraftServer.class", "com/mojang/minecraft/server/MinecraftServer.class"),
	MC_COMMON("net/minecraft/server/MinecraftServer.class"),
	MC_BUNDLER(EnvType.SERVER, "net/minecraft/bundler/Main.class", "org/bukkit/craftbukkit/bootstrap/Main.class"),
